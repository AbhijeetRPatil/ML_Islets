...
library('xlsx')
write.xlsx(DE_T1DvsCTL, file="DE_T1DvsCTL_Wilcoxon_AdjPvalue.xlsx", sheetName="All Cells-DE T1DvsCTL", row.names=T)
rm(DE_T1DvsCTL)
gc()
write.xlsx(DE_T1DvsCTL_acinar, file="DE_T1DvsCTL_Wilcoxon_AdjPvalue.xlsx", sheetName="Acinar-DE T1DvsCTL", append=TRUE, row.names=T)
rm(DE_T1DvsCTL_acinar)
gc()

write.xlsx(DE_T1DvsCTL_alpha, file="DE_T1DvsCTL_Wilcoxon_AdjPvalue.xlsx", sheetName="Alpha-DE T1DvsCTL", append=TRUE, row.names=T)
rm(DE_T1DvsCTL_alpha)
gc()

write.xlsx(DE_T1DvsCTL_beta, file="DE_T1DvsCTL_Wilcoxon_AdjPvalue.xlsx", sheetName="Beta-DE T1DvsCTL", append=TRUE, row.names=T)
rm(DE_T1DvsCTL_beta)
gc()

write.xlsx(DE_T1DvsCTL_delta, file="DE_T1DvsCTL_Wilcoxon_AdjPvalue.xlsx", sheetName="Delta-DE T1DvsCTL", append=TRUE, row.names=T)
rm(DE_T1DvsCTL_delta)
gc()

write.xlsx(DE_T1DvsCTL_ductal, file="DE_T1DvsCTL_Wilcoxon_AdjPvalue.xlsx", sheetName="Ductal-DE T1DvsCTL", append=TRUE, row.names=T)
rm(DE_T1DvsCTL_ductal)
gc()

write.xlsx(DE_T1DvsCTL_endothelial, file="DE_T1DvsCTL_Wilcoxon_AdjPvalue.xlsx", sheetName="Endothelial-DE T1DvsCTL", append=TRUE, row.names=T)
rm(DE_T1DvsCTL_endothelial)
gc()

write.xlsx(DE_T1DvsCTL_immune, file="DE_T1DvsCTL_Wilcoxon_AdjPvalue.xlsx", sheetName="Immune-DE T1DvsCTL", append=TRUE, row.names=T)
rm(DE_T1DvsCTL_immune)
gc()

write.xlsx(DE_T1DvsCTL_stellates, file="DE_T1DvsCTL_Wilcoxon_AdjPvalue.xlsx", sheetName="Stellates-DE T1DvsCTL", append=TRUE, row.names=T)
