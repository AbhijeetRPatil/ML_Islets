...
library('xlsx')
write.xlsx(DE_T1DvsAAB, file="DE_T1DvsAAB_Wilcoxon_AdjPvalue.xlsx", sheetName="All Cells-DE T1DvsAAB", row.names=T)
rm(DE_T1DvsAAB)
gc()
write.xlsx(DE_T1DvsAAB_acinar, file="DE_T1DvsAAB_Wilcoxon_AdjPvalue.xlsx", sheetName="Acinar-DE T1DvsAAB", append=TRUE, row.names=T)
rm(DE_T1DvsAAB_acinar)
gc()

write.xlsx(DE_T1DvsAAB_alpha, file="DE_T1DvsAAB_Wilcoxon_AdjPvalue.xlsx", sheetName="Alpha-DE T1DvsAAB", append=TRUE, row.names=T)
rm(DE_T1DvsAAB_alpha)
gc()

write.xlsx(DE_T1DvsAAB_beta, file="DE_T1DvsAAB_Wilcoxon_AdjPvalue.xlsx", sheetName="Beta-DE T1DvsAAB", append=TRUE, row.names=T)
rm(DE_T1DvsAAB_beta)
gc()

write.xlsx(DE_T1DvsAAB_delta, file="DE_T1DvsAAB_Wilcoxon_AdjPvalue.xlsx", sheetName="Delta-DE T1DvsAAB", append=TRUE, row.names=T)
rm(DE_T1DvsAAB_delta)
gc()

write.xlsx(DE_T1DvsAAB_ductal, file="DE_T1DvsAAB_Wilcoxon_AdjPvalue.xlsx", sheetName="Ductal-DE T1DvsAAB", append=TRUE, row.names=T)
rm(DE_T1DvsAAB_ductal)
gc()

write.xlsx(DE_T1DvsAAB_endothelial, file="DE_T1DvsAAB_Wilcoxon_AdjPvalue.xlsx", sheetName="Endothelial-DE T1DvsAAB", append=TRUE, row.names=T)
rm(DE_T1DvsAAB_endothelial)
gc()

write.xlsx(DE_T1DvsAAB_immune, file="DE_T1DvsAAB_Wilcoxon_AdjPvalue.xlsx", sheetName="Immune-DE T1DvsAAB", append=TRUE, row.names=T)
rm(DE_T1DvsAAB_immune)
gc()

write.xlsx(DE_T1DvsAAB_stellates, file="DE_T1DvsAAB_Wilcoxon_AdjPvalue.xlsx", sheetName="Stellates-DE T1DvsAAB", append=TRUE, row.names=T)
