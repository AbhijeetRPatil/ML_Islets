...
library("ggplot2")
library("stringr")
setwd("C:/Users/abhij/Desktop/Spring 2022/ML paper/RRA_New")

#########################
## All cells
KEGG_G1_All <- read.csv("./rankedlists/t1dvsctrl/All_KEGG.csv")
...
## Alpha cells
KEGG_G1_Alpha <- read.csv("./rankedlists/t1dvsctrl/alpha_KEGG.csv")
...
## Ductal cells
KEGG_G1_Ductal <- read.csv("./rankedlists/t1dvsctrl/ductal_KEGG.csv")
...
KEGG_G1_Immune <- read.csv("./rankedlists/t1dvsctrl/immune_KEGG.csv")
...
## Beta cells
KEGG_G1_Beta <- read.csv("./rankedlists/t1dvsctrl/beta_KEGG.csv")
...
## Endothelial cells
KEGG_G1_Endothelial <- read.csv("./rankedlists/t1dvsctrl/endothelial_KEGG.csv")
...
## Acinar cells
KEGG_G1_Acinar <- read.csv("./rankedlists/t1dvsctrl/acinar_KEGG.csv")
...
## Stellates cells
KEGG_G1_Stellates <- read.csv("./rankedlists/t1dvsctrl/stellates_KEGG.csv")
...
## Delta cells
KEGG_G1_Delta <- read.csv("./rankedlists/t1dvsctrl/delta_KEGG.csv")
...
p8 <- kegg_subplot(KEGG_All, "T1D vs CTL- KEGG Pathways (FDR < 0.05)")
pdf("./rankedlists/t1dvsctrl/KEGG_T1DvsCTL_ALLFDR.pdf", width = 8, height = 12)
p8
dev.off()
