...
#########################
## All cells
KEGG_G1_All <- read.csv("./rankedlists/t1dvsaab/All_KEGG.csv")
...
## Alpha cells
KEGG_G1_Alpha <- read.csv("./rankedlists/t1dvsaab/alpha_KEGG.csv")
...
## Ductal cells
KEGG_G1_Ductal <- read.csv("./rankedlists/t1dvsaab/ductal_KEGG.csv")
...
KEGG_G1_Immune <- read.csv("./rankedlists/t1dvsaab/immune_KEGG.csv")
...
## Beta cells
KEGG_G1_Beta <- read.csv("./rankedlists/t1dvsaab/beta_KEGG.csv")
...
## Endothelial cells
KEGG_G1_Endothelial <- read.csv("./rankedlists/t1dvsaab/endothelial_KEGG.csv")
...
## Acinar cells
KEGG_G1_Acinar <- read.csv("./rankedlists/t1dvsaab/acinar_KEGG.csv")
...
## Stellates cells
KEGG_G1_Stellates <- read.csv("./rankedlists/t1dvsaab/stellates_KEGG.csv")
...
## Delta cells
KEGG_G1_Delta <- read.csv("./rankedlists/t1dvsaab/delta_KEGG.csv")
...
p8 <- kegg_subplot(KEGG_All, "T1D vs AAB- KEGG Pathways (FDR < 0.05)")
pdf("./rankedlists/t1dvsaab/KEGG_T1DvsAAB_ALLFDR.pdf", width = 8, height = 12)
p8
dev.off()
