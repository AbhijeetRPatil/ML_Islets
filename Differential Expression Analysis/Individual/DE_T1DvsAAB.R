...
saveRDS(dat_T1DvsAAB.DE, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/DE_T1DvsAAB.rds")

## Alpha
dat_T1DvsAAB_alpha <- subset(dat_T1DvsAAB, subset = cell_type == "Alpha")
# saveRDS(dat_T1DvsAAB_alpha, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/T1DvsAAB_alpha.rds")
...
saveRDS(dat_T1DvsAAB_alpha.DE, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/DE_T1DvsAAB_alpha.rds")

## Beta
dat_T1DvsAAB_beta <- subset(dat_T1DvsAAB, subset = cell_type == "Beta")
# saveRDS(dat_T1DvsAAB_beta, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/T1DvsAAB_beta.rds")
...
saveRDS(dat_T1DvsAAB_beta.DE, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/DE_T1DvsAAB_beta.rds")

## Acinar
dat_T1DvsAAB_acinar <- subset(dat_T1DvsAAB, subset = cell_type == "Acinar")
# saveRDS(dat_T1DvsAAB_acinar, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/T1DvsAAB_acinar.rds")
...
saveRDS(dat_T1DvsAAB_acinar.DE, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/DE_T1DvsAAB_acinar.rds")

## Ductal
dat_T1DvsAAB_ductal <- subset(dat_T1DvsAAB, subset = cell_type == "Ductal")
# saveRDS(dat_T1DvsAAB_ductal, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/T1DvsAAB_ductal.rds")
...
saveRDS(dat_T1DvsAAB_ductal.DE, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/DE_T1DvsAAB_ductal.rds")


## Immune
dat_T1DvsAAB_immune <- subset(dat_T1DvsAAB, subset = cell_type == "Immune")
# saveRDS(dat_T1DvsAAB_immune, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/T1DvsAAB_immune.rds")
...
saveRDS(dat_T1DvsAAB_immune.DE, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/DE_T1DvsAAB_immune.rds")

## Delta
dat_T1DvsAAB_delta <- subset(dat_T1DvsAAB, subset = cell_type == "Delta")
# saveRDS(dat_T1DvsAAB_delta, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/T1DvsAAB_delta.rds")
...
saveRDS(dat_T1DvsAAB_delta.DE, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/DE_T1DvsAAB_delta.rds")

## Endothelial
dat_T1DvsAAB_endothelial <- subset(dat_T1DvsAAB, subset = cell_type == "Endothelial")
# saveRDS(dat_T1DvsAAB_endothelial, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/T1DvsAAB_endothelial.rds")
...
saveRDS(dat_T1DvsAAB_endothelial.DE, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/DE_T1DvsAAB_endothelial.rds")

## Stellates_Mesenchymal
dat_T1DvsAAB_stellates <- subset(dat_T1DvsAAB, subset = cell_type == "Stellates_Mesenchymal")
# saveRDS(dat_T1DvsAAB_stellates, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/T1DvsAAB_stellates.rds")
...
saveRDS(dat_T1DvsAAB_stellates.DE, "/mnt/alvand/abhijeet/aab/apr_WO-T2D/ml/res/DE/DE_T1DvsAAB_stellates.rds")
