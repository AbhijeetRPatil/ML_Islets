data.gen <- function()
{
  ...
  ## Alpha
  data_T1DvsAAB_alpha <-GetAssayData(dat_T1DvsAAB_alpha, assay="SCT",slot="data")
  ...
  ## Beta
  data_T1DvsAAB_beta <-GetAssayData(dat_T1DvsAAB_beta, assay="SCT",slot="data")
  ...
  ## Acinar
  data_T1DvsAAB_acinar <-GetAssayData(dat_T1DvsAAB_acinar, assay="SCT",slot="data")
  ...
  ## Ductal
  data_T1DvsAAB_ductal <-GetAssayData(dat_T1DvsAAB_ductal, assay="SCT",slot="data")
  ...
  ## Immune
  data_T1DvsAAB_immune <-GetAssayData(dat_T1DvsAAB_immune, assay="SCT",slot="data")
  ...
  ## Delta
  data_T1DvsAAB_delta <-GetAssayData(dat_T1DvsAAB_delta, assay="SCT",slot="data")
  ...
  ## Endothelial
  data_T1DvsAAB_endothelial <-GetAssayData(dat_T1DvsAAB_endothelial, assay="SCT",slot="data")
  ...
  ## Stellates
  data_T1DvsAAB_stellates <-GetAssayData(dat_T1DvsAAB_stellates, assay="SCT",slot="data")
