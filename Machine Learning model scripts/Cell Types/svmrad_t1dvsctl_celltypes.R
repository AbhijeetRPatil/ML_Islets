...
freq.matrix = function(train.x, method, ncores, test.x, train.y, test.y)
{
  if(method=="svm")
  {
    modelsvm.rad <- svm(train.x, as.factor(train.y), type = "C-classification",  kernel = "radial")
...
filename="alpha_svm_rad_t1dvsctl.rds"
alpha <- dat$alpha
cell.type <- "alpha"
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="beta_svm_rad_t1dvsctl.rds"
beta <- dat$beta
cell.type <- "beta"
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="acinar_svm_rad_t1dvsctl.rds"
acinar <- dat$acinar
cell.type <- "acinar"
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="ductal_svm_rad_t1dvsctl.rds"
ductal <- dat$ductal
cell.type <- "ductal"
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="delta_svm_rad_t1dvsctl.rds"
delta <- dat$delta
cell.type="delta"
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="endothelial_svm_rad_t1dvsctl.rds"
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="stellates_svm_rad_t1dvsctl.rds"
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="immune_svm_rad_t1dvsctl.rds"
immune <- dat$immune
cell.type = "immune"
