...
filename="alpha_xgb_t1dvsaab.rds"
alpha <- dat$alpha
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="beta_xgb_t1dvsaab.rds"
beta <- dat$beta
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="acinar_xgb_t1dvsaab.rds"
acinar <- dat$acinar
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="ductal_xgb_t1dvsaab.rds"
ductal <- dat$ductal
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="immune_xgb_t1dvsaab.rds"
immune <- dat$immune
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="delta_xgb_t1dvsaab.rds"
delta <- dat$delta
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="endothelial_xgb_t1dvsaab.rds"
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="stellates_xgb_t1dvsaab.rds"
