...
source("/Libraries/celltypes_data_gen_t1dvsaab.R")
# set random seed
set.seed(666)
##############################################################################################################################
...
filename="alpha_xgb_t1dvsaab_04302023_cv.rds"
alpha <- dat$alpha
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="beta_xgb_t1dvsaab_04302023_cv.rds"
beta <- dat$beta
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="acinar_xgb_t1dvsaab_04302023_cv.rds"
acinar <- dat$acinar
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="ductal_xgb_t1dvsaab_04302023_cv.rds"
ductal <- dat$ductal
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="immune_xgb_t1dvsaab_04302023_cv.rds"
immune <- dat$immune
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="delta_xgb_t1dvsaab_04302023_cv.rds"
delta <- dat$delta
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="endothelial_xgb_t1dvsaab_04302023_cv.rds"
...
start_time <- Sys.time()
print(paste0("Job sarted at ", start_time))
filename="stellates_xgb_t1dvsaab_04302023_cv.rds"
